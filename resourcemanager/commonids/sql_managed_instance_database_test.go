...
func TestNewSqlManagedInstanceDatabaseID(t *testing.T) {
	id := NewSqlManagedInstanceDatabaseID("12345678-1234-9876-4563-123456789012", "example-resource-group", "managedInstanceValue", "databaseValue")
...
func TestFormatSqlManagedInstanceDatabaseID(t *testing.T) {
	actual := NewSqlManagedInstanceDatabaseID("12345678-1234-9876-4563-123456789012", "example-resource-group", "managedInstanceValue", "databaseValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Sql/managedInstances/managedInstanceValue/databases/databaseValue"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseSqlManagedInstanceDatabaseID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *SqlManagedInstanceDatabaseId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Sql/managedInstances/managedInstanceValue/databases/databaseValue/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseManagedInstanceDatabaseID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseSqlManagedInstanceDatabaseIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *SqlManagedInstanceDatabaseId
	...
	for _, v := range testData {
		...
		actual, err := ParseSqlManagedInstanceDatabaseIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForSqlManagedInstanceDatabaseId(t *testing.T) {
	segments := SqlManagedInstanceDatabaseId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("SqlManagedInstanceDatabaseId has no segments")
	}
