...
func TestNewAppServiceEnvironmentID(t *testing.T) {
	id := NewAppServiceEnvironmentID("12345678-1234-9876-4563-123456789012", "example-resource-group", "hostingEnvironmentValue")
...
func TestFormatAppServiceEnvironmentID(t *testing.T) {
	actual := NewAppServiceEnvironmentID("12345678-1234-9876-4563-123456789012", "example-resource-group", "hostingEnvironmentValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Web/hostingEnvironments/hostingEnvironmentValue"
	if actual != expected {
...
func TestParseAppServiceEnvironmentID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Web/hostingEnvironments/hostingEnvironmentValue/extra",
			Error: true,
		},
	}
...
func TestParseAppServiceEnvironmentIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *AppServiceEnvironmentId
	...
	for _, v := range testData {
		...
		actual, err := ParseAppServiceEnvironmentIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForAppServiceEnvironmentId(t *testing.T) {
	segments := AppServiceEnvironmentId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("AppServiceEnvironmentId has no segments")
	}
