...
func TestNewSqlDatabaseID(t *testing.T) {
	id := NewSqlDatabaseID("12345678-1234-9876-4563-123456789012", "example-resource-group", "serverValue", "databaseValue")
...
func TestFormatSqlDatabaseID(t *testing.T) {
	actual := NewSqlDatabaseID("12345678-1234-9876-4563-123456789012", "example-resource-group", "serverValue", "databaseValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Sql/servers/serverValue/databases/databaseValue"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseSqlDatabaseID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Sql/servers/serverValue/databases/databaseValue/extra",
			Error: true,
		},
	}
...
func TestParseSqlDatabaseIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *SqlDatabaseId
	...
	for _, v := range testData {
		...
		actual, err := ParseSqlDatabaseIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForSqlDatabaseId(t *testing.T) {
	segments := SqlDatabaseId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("SqlDatabaseId has no segments")
	}
